...
email_notify="root,your_email@example.com"

# There are two possibilities:
#  1. start the need to ban IP (on stdin is empty)
#  2. when the script has already collected (if able to)
#     details about the attack (on stdin data about the attack)
