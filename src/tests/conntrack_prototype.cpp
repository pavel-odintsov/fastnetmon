...
// It's very raw API implementation for connection tracking code. Due to HUGE amount of collisions
// it's very slow: ~1Mpps For performance it's very close to std::map but much times more buggy :)
